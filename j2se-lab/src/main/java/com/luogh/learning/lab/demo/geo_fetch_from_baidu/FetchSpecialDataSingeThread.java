...
class ReaderSpecialResourceSingle{
	...
	private static final List<String> SPECIAL_AREA= Arrays.asList(new String[]{"日本","朝鲜","韩国","老挝","马来西亚","越南","泰国","印度","菲律宾"}); //
		...
		try{
			...
			while((line = in.readLine()) != null){
				...
				try{
					...
					if(!SPECIAL_AREA.contains(arr_entry[2].trim())) continue;
	...
	class SpecialData{
		...
		public String getJsonObj() {
			...
			StringBuilder sbuilder = new StringBuilder("{\"address\":\"FOREIGN|").append(this.country).append("|None|None|CHINANET|0|0\",\"content\":{\"address\":\"").append(this.country).append("\",\"address_detail\":{\"city\":\"").append(this.cityName).append("\",\"city_code\":7,\"district\":\"\",\"province\":\"").append(this.country).append("\",\"street\":\"\",\"street_number\":\"\"},\"point\":{\"x\":\"113.39481756\",\"y\":\"23.40800373\"}},\"status\":0}");

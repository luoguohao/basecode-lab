 ...
 * <tt><strong>bin/hadoop org.apache.hadoop.hbase.mapreduce.IndexBuilderTest TABLE_NAME COLUMN_FAMILY ATTR [ATTR ...]</strong></tt>
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class IndexBuilderTest extends Configured implements Tool {
  ...
  throws IOException {
    ...
    TableMapReduceUtil.initTableMapperJob(Lists.newArrayList(new Scan()), Map.class , ImmutableBytesWritable.class, Put.class, job);
  ...
  public int run(String[] args) throws Exception {
    ...
    if(args.length < 3) {
      ...
      System.err.println("Usage: IndexBuilderTest <TABLE_NAME> <COLUMN_FAMILY> <ATTR> [<ATTR> ...]");
      System.exit(-1);
    }
  ...
  public static void main(String[] args) throws Exception {
    int result = ToolRunner.run(HBaseConfiguration.create(), new IndexBuilderTest(), args);
    System.exit(result);
  }
}
